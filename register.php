...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($password !== $confirm) {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt = $pdo->prepare("INSERT INTO users (name, email, telephone, password, role, created_at) VALUES (?, ?, ?, ?, 'guest', NOW())");
            ...
            $stmt = $pdo->prepare("INSERT INTO wishlists (user_id, created_at) VALUES (?, NOW())");
            $stmt->execute([$id]);
...
<body class="bg-gray-100 py-10">
    ...
    <div class="max-w-2xl mx-auto flex flex-col items-center">
        ...
        <div class="bg-white p-10 rounded-xl shadow-md w-full">
            <h2 class="text-3xl font-bold text-center mb-8">Create your StayWhere Account</h2>
